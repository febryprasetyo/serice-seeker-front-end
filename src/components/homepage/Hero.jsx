  ...
  return (
    <section
      ...
      <div
        ...
        <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] text-[38px] text-white  text-center '>
          Find Reliable
          <span className='text-gradient'> Job and Service </span>
          Opportunities.
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5 mb-2 sm:mb-10`}>
